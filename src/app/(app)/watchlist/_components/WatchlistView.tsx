...
import { WatchlistManageModal } from "./WatchlistManageModal";
...
export function WatchlistView({ initialItems, initialLoadError }: Props) {
  useRequireAuth();
  const { items, loadError, actionError, addSymbol, removeSymbol } = useWatchlist(initialItems, initialLoadError);
